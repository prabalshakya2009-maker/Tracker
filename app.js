...
(function () {
  ...
  function openShortcutsModal() {
    openModal(`
      ...
      <div style="font-size:13px;line-height:1.8;color:var(--text-dim);">
        ...
        <p><b style="color:var(--text);">3</b> — Go to Heatmap Calendar</p>
        <p><b style="color:var(--text);">4</b> — Go to Discipline Analytics</p>
        <p><b style="color:var(--text);">5</b> — Go to Settings &amp; Configuration</p>
  ...
  /* ==========================================================================
     TAB NAVIGATION & ROUTING (5 Workable, Practical Tabs)
     ========================================================================== */
  ...
  function switchTab(tabName) {
    ...
    // Graceful backward-compatible aliases
    if (tabName === "progress") activeTab = "calendar";
    if (tabName === "settings" || tabName === "studio") activeTab = "manage";

    const target = document.getElementById(`view-${activeTab}`);
    if (!target) {
      console.warn(`[Winter Arc] Tab target view-${activeTab} not found.`);
      return;
    }
    ...
    // Reset scroll position on tab transition
  ...
  // Expose globally so inline onclick handlers on both mobile and PC work immediately
  window.switchTab = switchTab;
  window.nudgeTimer = nudgeTimer;
  ...
  function initEvents() {
    ...
    // Global Keyboard Navigation (1: Today, 2: Focus, 3: Calendar, 4: Stats, 5: Settings)
    window.addEventListener("keydown", (e) => {
